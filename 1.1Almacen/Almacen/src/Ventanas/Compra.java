...
public class Compra extends javax.swing.JFrame {
    ...
    String cap="";
    int c=0,d=0,e=0,idmiguel=0,idmi=0;
    ...
    private void initComponents() {
        ...
        Quitar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/delete-item.png"))); // NOI18N
...
String idp="",idnom="",stock="",canti="",stock2="";
    ...
    try {
        ...
        psta.execute();
                ...
                sqlinsertar="INSERT INTO COMPRA@DBLINKCHAVA values (?,?,?,?,?)";
        psta=conn.prepareStatement(sqlinsertar);
        psta.setString(1, idcompra.getText());
        psta.setString(2, fecha.getText());
        psta.setString(3, totalneto.getText());
        ...
        psta.execute();
                ...
                sqlinsertar="INSERT INTO COMPRA@DBLINKHUGO values (?,?,?,?,?)";
        psta=conn.prepareStatement(sqlinsertar);
        psta.setString(1, idcompra.getText());
        psta.setString(2, fecha.getText());
        psta.setString(3, totalneto.getText());
        ...
        while(i<filass){
            ...
            op=conn.prepareStatement("UPDATE INVENTARIO@DBLINKCHAVA SET STOCK ='"+actualiza+"' WHERE ID_PRODUCTO='"+idp+"'");
            op.executeUpdate();
            ...
            sqlinsert="INSERT INTO DETALLE_COMPRA@DBLINKCHAVA values (?,?,?,?,?,?)";
            psta=conn.prepareStatement(sqlinsert);
            psta.setString(1, idcompra.getText());
            psta.setString(2, idp);
            psta.setString(3, orden.getValueAt(i,1).toString());
            ...
            sqlinsert="INSERT INTO DETALLE_COMPRA@DBLINKHUGO values (?,?,?,?,?,?)";
            psta=conn.prepareStatement(sqlinsert);
            psta.setString(1, idcompra.getText());
            psta.setString(2, idp);
            psta.setString(3, orden.getValueAt(i,1).toString());
    ...
    private void RegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegresarActionPerformed
        ...
        Principal.usuario.setText(usuariov.getText());
        Principal.id.setText(idpersonalv.getText());
        }
    ...
    public static javax.swing.JLabel idpersonalv;
