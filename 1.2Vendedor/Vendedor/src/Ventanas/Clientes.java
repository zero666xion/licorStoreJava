        ...
        public void keyTyped(java.awt.event.KeyEvent evt) {
            ...
            try{
                ...
                Statement st=conn.createStatement();
                    ...
                    id.setText(Integer.toString(c+1));
                    id.disable();
                    rs.close();
                    }catch (Exception ex) {
                    ex.printStackTrace();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 919, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
            .addGroup(layout.createSequentialGroup()
                .addGap(423, 423, 423)
...
try {
            ...
            if(rs.next()){
                ...
                psta.execute();
                                ...
                                sqlinsertar="INSERT INTO CLIENTE@DBLINKCHAVA values (?,?,?,?,?,?,?,?)";
                psta=conn.prepareStatement(sqlinsertar);
                psta.setString(1, id.getText());
                psta.setString(2, nombre.getText());
                psta.setString(3, paterno.getText());
...
try {
        ...
        JOptionPane.showMessageDialog(null,"POR FAVOR, INGRESE LOS DATOS NECESARIOS");       
            ...
            op=conn.prepareStatement("UPDATE CLIENTE@DBLINKCHAVA SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', RFC ='"+rfc.getText()+"' WHERE ID_CLIENTE ='"+id.getText()+"'");
            op.executeUpdate();
    ...
    private void RegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegresarActionPerformed
        ...
        if (eleccion == JOptionPane.YES_OPTION)
        {
                ...
                Principal.usuario.setText(usuariocl.getText());
                Principal.id.setText(idcli.getText());
        }
    ...
    public static javax.swing.JTextField usuariocl;
