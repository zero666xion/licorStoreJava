...
String direc="";
        ...
        try {
            ...
            if(rs.next()){
                ...
                String Variable="1";
                String sqlinsertar="INSERT INTO PROVEEDOR values (?,?,?,?,?,?,?)";
                ...
                sqlinsertar="INSERT INTO PROVEEDOR@DBLINKMIGUEL values (?,?,?,?,?,?,?,?)";
                ...
                sqlinsertar="INSERT INTO PROVEEDOR@DBLINKCHAVA values (?,?,?,?,?,?,?,?)";
                psta=conn.prepareStatement(sqlinsertar);
                psta.setString(1, Integer.toString(c));
                psta.setString(2, nombre.getText());
                psta.setString(3, direccion.getText());
...
try {
        ...
        JOptionPane.showMessageDialog(null,"POR FAVOR, INGRESE LOS DATOS NECESARIOS");       
            ...
            String Variable="1";
            PreparedStatement op=conn.prepareStatement("UPDATE PROVEEDOR SET NOMBRE ='"+nombre.getText()+"', DIRECCION='"+direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', RFC ='"+rfc.getText()+"', CONTACTO ='"+contacto.getText()+"' WHERE ID_PROVEEDOR ='"+id.getText()+"'");
            op.executeUpdate();
                ...
                op=conn.prepareStatement("UPDATE PROVEEDOR@DBLINKMIGUEL SET NOMBRE ='"+nombre.getText()+"', DIRECCION='"+direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', RFC ='"+rfc.getText()+"', CONTACTO ='"+contacto.getText()+"' WHERE ID_PROVEEDOR ='"+id.getText()+"'");
                op.executeUpdate();
                ...
                op=conn.prepareStatement("UPDATE PROVEEDOR@DBLINKCHAVA SET NOMBRE ='"+nombre.getText()+"', DIRECCION='"+direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', RFC ='"+rfc.getText()+"', CONTACTO ='"+contacto.getText()+"' WHERE ID_PROVEEDOR ='"+id.getText()+"'");
                op.executeUpdate();
