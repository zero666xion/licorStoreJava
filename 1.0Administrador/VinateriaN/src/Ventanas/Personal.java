...
Object [] opciones ={"SI","NO"};
        ...
        if (eleccion == JOptionPane.YES_OPTION){
            ...
            op.executeUpdate();
                ...
                op=conn.prepareStatement("UPDATE PERSONAL@DBLINKBETO SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+id.getText()+"'");
                op.executeUpdate();
                
                op=conn.prepareStatement("UPDATE PERSONAL@DBLINKHUGO SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+id.getText()+"'");
                op.executeUpdate();

                op=conn.prepareStatement("UPDATE USUARIOS@DBLINKMIGUEL SET ID_STATUS ='2' WHERE ID_PERSONAL ='" + idmip +"'");
                op.executeUpdate();
                
                op=conn.prepareStatement("UPDATE USUARIOS@DBLINKBETO SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+id.getText()+"'");
                op.executeUpdate();
            
                op=conn.prepareStatement("UPDATE USUARIOS@DBLINKHUGO SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+id.getText()+"'");
                op.executeUpdate();
        ...
        try {
            ...
            if(rs.next()){
                ...
                try{
                    ...
                    sqlinsertar="INSERT INTO PERSONAL@DBLINKBETO values (?,?,?,?,?,?,?,?,?,?,?)";
                    psta=conn.prepareStatement(sqlinsertar);
                    psta.setString(1, id.getText());
                    psta.setString(2, nombre.getText());
                    psta.setString(3, paterno.getText());
                    ...
                    sqlinsertar="INSERT INTO PERSONAL@DBLINKHUGO values (?,?,?,?,?,?,?,?,?,?,?)";
                    psta=conn.prepareStatement(sqlinsertar);
                    psta.setString(1, id.getText());
                    psta.setString(2, nombre.getText());
                    psta.setString(3, paterno.getText());
        ...
        JOptionPane.showMessageDialog(null,"POR FAVOR, INGRESE LOS DATOS NECESARIOS");       
            ...
            op.executeUpdate();
              ...
              try{
                ...
                op=conn.prepareStatement("UPDATE PERSONAL@DBLINKBETO SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+Direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', ID_SEXO ='"+idsexo+"', ID_JORNADA_LABORAL ='" +idjornada+ "' WHERE ID_PERSONAL ='"+id.getText()+"'");
                op.executeUpdate();
                
                op=conn.prepareStatement("UPDATE PERSONAL@DBLINKHUGO SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+Direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', ID_SEXO ='"+idsexo+"', ID_JORNADA_LABORAL ='" +idjornada+ "' WHERE ID_PERSONAL ='"+id.getText()+"'");
                op.executeUpdate();
