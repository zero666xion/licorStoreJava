...
try{
            ...
            if(usuario.getText().trim().length()==0 || password.getText().trim().length()==0){
               ...
               try{
                    ...
                    op=conn.prepareStatement("UPDATE USUARIOS@DBLINKBETO SET ID_PERSONAL ='"+id.getText()+"', USUARIO ='"+usuario.getText()+"', PASSWORD='"+password.getText()+"' WHERE ID_PERSONAL ='"+id.getText()+"'");
                    op.executeUpdate();
                    
                    op=conn.prepareStatement("UPDATE USUARIOS@DBLINKHUGO SET ID_PERSONAL ='"+id.getText()+"', USUARIO ='"+usuario.getText()+"', PASSWORD='"+password.getText()+"' WHERE ID_PERSONAL ='"+id.getText()+"'");
                    op.executeUpdate();
