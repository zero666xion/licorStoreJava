...
try {
        ...
        if(rs.next()){
            ...
            op=conn.prepareStatement("UPDATE VENTA@DBLINKHUGO SET ID_STATUS ='2' WHERE ID_VENTA ='"+IDVENTA.getText()+"'");
            op.executeUpdate();
            
            op=conn.prepareStatement("UPDATE VENTA@DBLINKBETO SET ID_STATUS ='2' WHERE ID_VENTA ='"+IDVENTA.getText()+"'");
            op.executeUpdate();

            op=conn.prepareStatement("UPDATE DETALLE_VENTA@DBLINKMIGUEL SET ID_STATUS ='2' WHERE ID_VENTA ='"+ c +"'");
            op.executeUpdate();
            
            op=conn.prepareStatement("UPDATE DETALLE_VENTA@DBLINKBETO SET ID_STATUS ='2' WHERE ID_VENTA ='"+IDVENTA.getText()+"'");
            op.executeUpdate();
            
            op=conn.prepareStatement("UPDATE DETALLE_VENTA@DBLINKHUGO SET ID_STATUS ='2' WHERE ID_VENTA ='"+IDVENTA.getText()+"'");
            op.executeUpdate();
