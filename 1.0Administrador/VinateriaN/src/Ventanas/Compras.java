...
Object [] opciones ={"SI","NO"};
        ...
        try{
            ...
            Statement st=conn.createStatement();
                ...
                op=conn.prepareStatement("UPDATE COMPRA@DBLINKBETO SET ID_STATUS ='2' WHERE ID_COMPRA ='"+IDCOMPRAS.getText()+"'");
                op.executeUpdate();
                
                op=conn.prepareStatement("UPDATE COMPRA@DBLINKHUGO SET ID_STATUS ='2' WHERE ID_COMPRA ='"+IDCOMPRAS.getText()+"'");
                op.executeUpdate();

                op=conn.prepareStatement("UPDATE DETALLE_COMPRA@DBLINKMIGUEL SET ID_STATUS ='2' WHERE ID_COMPRA ='"+ idmiguel +"'");
                op.executeUpdate();
                
                op=conn.prepareStatement("UPDATE DETALLE_COMPRA@DBLINKBETO SET ID_STATUS ='2' WHERE ID_COMPRA ='"+IDCOMPRAS.getText()+"'");
                op.executeUpdate();
                
                op=conn.prepareStatement("UPDATE DETALLE_COMPRA@DBLINKHUGO SET ID_STATUS ='2' WHERE ID_COMPRA ='"+IDCOMPRAS.getText()+"'");
                op.executeUpdate();
