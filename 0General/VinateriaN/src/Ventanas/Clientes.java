...
try {
            ...
            if(rs.next()){
                ...
                String sqlinsertar="INSERT INTO CLIENTE@DBLINKCHAVA values (?,?,?,?,?,?,?,?)";
                ...
                sqlinsertar="INSERT INTO CLIENTE values (?,?,?,?,?,?,?,?)";
                psta=conn.prepareStatement(sqlinsertar);
                psta.setString(1, id.getText());
...
try {
        ...
        JOptionPane.showMessageDialog(null,"POR FAVOR, INGRESE LOS DATOS NECESARIOS");       
            ...
            PreparedStatement op=conn.prepareStatement("UPDATE CLIENTE@DBLINKCHAVA SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', RFC ='"+rfc.getText()+"' WHERE ID_CLIENTE ='"+id.getText()+"'");
            op.executeUpdate();
            ...
            op=conn.prepareStatement("UPDATE CLIENTE SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', RFC ='"+rfc.getText()+"' WHERE ID_CLIENTE ='"+id.getText()+"'");
            op.executeUpdate();
