...
public class Personal extends javax.swing.JFrame {
    ...
    int fila=0,maxicoa1=0,maxieca1=0; String maxicoa="",maxieca="",idpercha="",idperric="",idpercha2="",idperric2="";
    String datos[]=new String[11];
    String coacalco="COACALCO",ecatepec="ECATEPEC";
    ...
    public Personal() {
        ...
        public void mousePressed(MouseEvent Mouse_evt) {
            ...
            if (Mouse_evt.getClickCount() == 1) {
                ...
                Sucursal.setSelectedItem(tablapersonal.getValueAt(fila,8));
                ...
                if(Sucursal.getSelectedItem().toString().equals(ecatepec)){
                try{
                     conn=Conexion.Enlace(conn);
                    String MAX="SELECT ID_PERSONAL FROM PERSONAL@DBLINKRICHI WHERE NOMBRE ='"+nombre.getText()+"' AND PATERNO='" + paterno.getText()+"' AND MATERNO='"+materno.getText()+"' AND TELEFONO='"+telefono.getText()+"'";
                    Statement st=conn.createStatement();
                    ResultSet rs=st.executeQuery(MAX);
                    if(rs.next()){
                        idperric2=rs.getString("ID_PERSONAL");
                    }
                }catch(SQLException e){
                   
                }
                }else if(Sucursal.getSelectedItem().toString().equals(coacalco)){
                try{
                     conn=Conexion.Enlace(conn);
                    String MAX="SELECT ID_PERSONAL FROM PERSONAL@DBLINKCHAVA WHERE NOMBRE ='"+nombre.getText()+"' AND PATERNO='" + paterno.getText()+"' AND MATERNO='"+materno.getText()+"' AND TELEFONO='"+telefono.getText()+"'";
                    Statement st=conn.createStatement();
                    ResultSet rs=st.executeQuery(MAX);
                    if(rs.next()){
                        idpercha2=rs.getString("ID_PERSONAL");
                    }
               }catch(SQLException e){
...
if(Sucursal.getSelectedItem().toString().equals(coacalco)){
try{
conn=Conexion.Enlace(conn);   
        ...
        if (eleccion == JOptionPane.YES_OPTION){
            ...
            op.executeUpdate();
             ...
             try{
                    ...
                    ResultSet rs=st.executeQuery(MAX);
                    if(rs.next()){
                        idpercha=rs.getString("ID_PERSONAL");
                    }
               }catch(SQLException e){
                           ...
                           op=conn.prepareStatement("UPDATE PERSONAL@DBLINKCHAVA SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idpercha+"'");
                           op.executeUpdate();
                           
                                       
                           op=conn.prepareStatement("UPDATE PERSONAL@DBLINKBETO SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idpercha+"'");
                           op.executeUpdate();
                           
                                      
                           op=conn.prepareStatement("UPDATE PERSONAL@DBLINKHUGO SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idpercha+"'");
                           op.executeUpdate();

                           op=conn.prepareStatement("UPDATE USUARIOS@DBLINKCHAVA SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idpercha+"'");
                           op.executeUpdate();
                           
                                      
                           op=conn.prepareStatement("UPDATE USUARIOS@DBLINKBETO SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idpercha+"'");
                           op.executeUpdate();
                           
                                       
                           op=conn.prepareStatement("UPDATE USUARIOS@DBLINKHUGO SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idpercha+"'");
                           op.executeUpdate();
...
else if(Sucursal.getSelectedItem().toString().equals(ecatepec)){
try{
conn=Conexion.Enlace(conn);   
conn.setAutoCommit(false);
conn.setTransactionIsolation(Connection.TRANSACTION_SERIALIZABLE);
        ...
        if (eleccion == JOptionPane.YES_OPTION){
            ...
            op.executeUpdate();
                ...
                try{
                    ...
                    ResultSet rs=st.executeQuery(MAX);
                    if(rs.next()){
                        idperric=rs.getString("ID_PERSONAL");
                    }
               }catch(SQLException e){
                           ...
                           op=conn.prepareStatement("UPDATE PERSONAL@DBLINKRICHI SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idperric+"'");
                           op.executeUpdate();
                           
                                      
                           op=conn.prepareStatement("UPDATE PERSONAL@DBLINKMATA SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idperric+"'");
                           op.executeUpdate();
                           
                                       
                           op=conn.prepareStatement("UPDATE PERSONAL@DBLINKPROFE SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idperric+"'");
                           op.executeUpdate();

            
                           op=conn.prepareStatement("UPDATE USUARIOS@DBLINKRICHI SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idperric+"'");
                           op.executeUpdate();
                           
                                       
                           op=conn.prepareStatement("UPDATE USUARIOS@DBLINKMATA SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idperric+"'");
                           op.executeUpdate();
                           
                                       
                           op=conn.prepareStatement("UPDATE USUARIOS@DBLINKPROFE SET ID_STATUS ='2' WHERE ID_PERSONAL ='"+idperric+"'");
                           op.executeUpdate();
        ...
        try{
            ...
            if(rs.next()){
                JOptionPane.showMessageDialog(null, "El personal que desea agregar, ya existe. \nCorrobore sus datos");
                    ...
                    try{
                     conn=Conexion.Enlace(conn);
                    String MAX="SELECT MAX(ID_PERSONAL) AS ID_PERSONAL FROM PERSONAL@DBLINKCHAVA";
                    Statement st=conn.createStatement();
                    ResultSet rs=st.executeQuery(MAX);
                    if(rs.next()){
                        maxicoa=rs.getString("ID_PERSONAL");
                    }
                    }catch(SQLException e){ }
                    
                    maxicoa1= Integer.parseInt(maxicoa)+1;

                    String sqlinsertar1="INSERT INTO PERSONAL@DBLINKCHAVA values (?,?,?,?,?,?,?,?,?,?,?)";
                    PreparedStatement psta1=conn.prepareStatement(sqlinsertar1);
                    psta1.setString(1, Integer.toString(maxicoa1));
                    psta1.setString(2, nombre.getText());
                    psta1.setString(3, paterno.getText());
                    psta1.setString(4, materno.getText());
                    psta1.setString(5, Direccion.getText());
                    psta1.setString(6, telefono.getText());
                    psta1.setString(7, email.getText());
                    psta1.setString(8, idsexo);
                    psta1.setString(9, idjornada);
                    psta1.setString(10, Sucursal.getSelectedItem().toString());
                    psta1.setString(11,Variable);
                    psta1.execute();

                    sqlinsertar1="INSERT INTO PERSONAL@DBLINKHUGO values (?,?,?,?,?,?,?,?,?,?,?)";
                    psta1=conn.prepareStatement(sqlinsertar1);
                    psta1.setString(1, Integer.toString(maxicoa1));
                    psta1.setString(2, nombre.getText());
                    psta1.setString(3, paterno.getText());
                    psta1.setString(4, materno.getText());
                    ...
                    sqlinsertar1="INSERT INTO PERSONAL@DBLINKBETO values (?,?,?,?,?,?,?,?,?,?,?)";
                    psta1=conn.prepareStatement(sqlinsertar1);
                    psta1.setString(1, Integer.toString(maxicoa1));
                    psta1.setString(2, nombre.getText());
                    psta1.setString(3, paterno.getText());
        ...
        try{
            ...
            if(rs.next()){
                JOptionPane.showMessageDialog(null, "El personal que desea agregar, ya existe. \nCorrobore sus datos");
                    ...
                    try{
                     conn=Conexion.Enlace(conn);
                    String MAX="SELECT MAX(ID_PERSONAL) AS ID_PERSONAL FROM PERSONAL@DBLINKRICHI ";
                    Statement st=conn.createStatement();
                    ResultSet rs=st.executeQuery(MAX);
                    if(rs.next()){
                        maxieca=rs.getString("ID_PERSONAL");
                    }
                    }catch(SQLException e){ }
                    
                    maxieca1= Integer.parseInt(maxieca)+1;

                    String sqlinsertar1="INSERT INTO PERSONAL@DBLINKRICHI values (?,?,?,?,?,?,?,?,?,?,?)";
                    PreparedStatement psta1=conn.prepareStatement(sqlinsertar1);
                    psta1.setString(1, Integer.toString(maxieca1));
                    psta1.setString(2, nombre.getText());
                    psta1.setString(3, paterno.getText());
                    psta1.setString(4, materno.getText());
                    psta1.setString(5, Direccion.getText());
                    ...
                    sqlinsertar1="INSERT INTO PERSONAL@DBLINKPROFE values (?,?,?,?,?,?,?,?,?,?,?)";
                    psta1=conn.prepareStatement(sqlinsertar1);
                    psta1.setString(1, Integer.toString(maxieca1));
                    psta1.setString(2, nombre.getText());
                    psta1.setString(3, paterno.getText());
                    ...
                    sqlinsertar1="INSERT INTO PERSONAL@DBLINKMATA values (?,?,?,?,?,?,?,?,?,?,?)";
                    psta1=conn.prepareStatement(sqlinsertar1);
                    psta1.setString(1, Integer.toString(maxieca1));
                    psta1.setString(2, nombre.getText());
                    psta1.setString(3, paterno.getText());
...
conn.commit();
    ...
    try {
        ...
        JOptionPane.showMessageDialog(null,"POR FAVOR, INGRESE LOS DATOS NECESARIOS");       
            ...
            PreparedStatement op=conn.prepareStatement("UPDATE PERSONAL@DBLINKCHAVA SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+Direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', ID_SEXO ='"+idsexo+"', ID_JORNADA_LABORAL ='" +idjornada+ "' WHERE ID_PERSONAL ='"+idpercha2+"'");
            op.executeUpdate();
            
            op=conn.prepareStatement("UPDATE PERSONAL@DBLINKBETO SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+Direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', ID_SEXO ='"+idsexo+"', ID_JORNADA_LABORAL ='" +idjornada+ "' WHERE ID_PERSONAL ='"+idpercha2+"'");
            op.executeUpdate();
            
            op=conn.prepareStatement("UPDATE PERSONAL@DBLINKHUGO SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+Direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', ID_SEXO ='"+idsexo+"', ID_JORNADA_LABORAL ='" +idjornada+ "' WHERE ID_PERSONAL ='"+idpercha2+"'");
            op.executeUpdate();
            
            op=conn.prepareStatement("UPDATE PERSONAL SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+Direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', ID_SEXO ='"+idsexo+"', ID_JORNADA_LABORAL ='" +idjornada+ "' WHERE ID_PERSONAL ='"+id.getText()+"'");
            op.executeUpdate();
...
conn.commit();
    ...
    try {
        ...
        JOptionPane.showMessageDialog(null,"POR FAVOR, INGRESE LOS DATOS NECESARIOS");       
            ...
            PreparedStatement op=conn.prepareStatement("UPDATE PERSONAL@DBLINKRICHI SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+Direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', ID_SEXO ='"+idsexo+"', ID_JORNADA_LABORAL ='" +idjornada+ "' WHERE ID_PERSONAL ='"+idperric2+"'");
            op.executeUpdate();
            
            op=conn.prepareStatement("UPDATE PERSONAL@DBLINKMATA SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+Direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', ID_SEXO ='"+idsexo+"', ID_JORNADA_LABORAL ='" +idjornada+ "' WHERE ID_PERSONAL ='"+idperric2+"'");
            op.executeUpdate();
            
            op=conn.prepareStatement("UPDATE PERSONAL@DBLINKPROFE SET NOMBRE ='"+nombre.getText()+"', PATERNO ='"+paterno.getText()+"', MATERNO='"+materno.getText()+"',DIRECCION='"+Direccion.getText()+"', TELEFONO ='"+telefono.getText()+"',CORREO ='"+email.getText()+"', ID_SEXO ='"+idsexo+"', ID_JORNADA_LABORAL ='" +idjornada+ "' WHERE ID_PERSONAL ='"+idperric2+"'");
            op.executeUpdate();
